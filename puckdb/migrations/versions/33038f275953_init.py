...
Revision ID: 33038f275953
Revises: 
Create Date: 2018-12-21 15:08:25.526224
...
def upgrade():
    ...
    sa.Column('type', sa.Enum('unknown', 'regular', 'playoff', 'allstar', name='game_type'), nullable=True),
